package org.pingeb.finder.animation;
...
public class AnimationFactory {
	...
	public static Animation getButtonInitAnimation(){	
		Animation anim;
		
		anim = new AlphaAnimation(1f, 0.8f);
	...
	public static Animation getBackgroundInitAnimation(){	
		Animation anim;
		
		anim = new AlphaAnimation(1f, 0.95f);
